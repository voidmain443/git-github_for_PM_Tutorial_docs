...
STYLE='''*{box-sizing:border-box}body{margin:0;background:#f4f6f2;color:#183b31;font:17px/1.8 system-ui,sans-serif}a{color:#14664e}a:focus-visible,button:focus-visible,select:focus-visible{outline:3px solid #339c72;outline-offset:4px}header{border-bottom:1px solid #dce5dc;background:white}nav,main,footer{max-width:1120px;margin:auto;padding:22px}nav{display:flex;justify-content:space-between;gap:16px;flex-wrap:wrap}nav a{text-decoration:none}nav .links{display:flex;gap:22px;flex-wrap:wrap}.hero{padding:45px 0 30px;max-width:800px}.eyebrow{font-size:13px;letter-spacing:.14em;color:#4e7464}h1{font-size:clamp(30px,5vw,48px);line-height:1.3;letter-spacing:-.04em}h2{font-size:26px;margin-top:42px}h3{font-size:19px;margin:0 0 10px}.muted{color:#597065}.actions{display:flex;gap:12px;flex-wrap:wrap;margin:25px 0}.button{display:inline-block;border:1px solid #99b4a2;background:white;border-radius:9px;padding:12px 20px;text-decoration:none}.primary{background:#175940;color:white;border-color:#175940}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:18px}.card{background:white;border:1px solid #d7e1d7;border-radius:12px;padding:24px}.card a{font-weight:600}.number{font-size:13px;color:#52775f}details{border-top:1px solid #d7e1d7;margin-top:16px;padding:16px 0}summary{cursor:pointer;font-weight:600}table{border-collapse:collapse;width:100%;font-size:15px}td,th{border:1px solid #ceddce;padding:10px;vertical-align:top;text-align:left}.reading-table{overflow-x:auto}select,button{font:inherit;padding:9px;border:1px solid #99b4a2;border-radius:6px}footer{font-size:13px;color:#597065}.skip{position:absolute;top:-60px}.skip:focus{top:5px;background:white;padding:12px}p{overflow-wrap:anywhere}@media(max-width:560px){main,nav,footer{padding:18px}.hero{padding-top:20px}.card{padding:20px}}'''
NAV='<a class="skip" href="#content">본문으로 바로가기</a><header><nav aria-label="주 메뉴"><a href="index.html"><strong>모아페이 · 금융 PM 실습</strong></a><div class="links"><a href="learn.html?unit=0">교재</a><a href="erp.html">ERP</a><a href="guide.html">사용 안내</a><a href="resources.html">자료실</a></div></nav></header>'
...
<section><h2>자료가 아직 없다면</h2><p>처음 조회 시점은 S0, 착수 전입니다. 승인된 기준선이나 실적이 비어 있는 것이 정상입니다. 교재에서 검토를 마친 뒤 상단의 자료 선택으로 다음 시점을 엽니다.</p><details><summary>초안·검토·승인은 어떻게 다른가요?</summary><p>초안은 PM이 작성한 제안입니다. 검토는 담당자가 근거와 조건을 확인하는 일입니다. 승인은 권한 있는 사람이 해당 버전을 결정하는 일입니다. 예제를 읽거나 다음 자료를 열었다고 내 문서가 자동 승인되는 것은 아닙니다.</p></details><details><summary>완성 답안과 개인정보는 어디에 있나요?</summary><p>이 사이트에는 학생 설명·부분 예제·빈 양식·가상 회사 자료를 제공합니다. 강사용 완성 답안과 개인 실습 기록은 배포하지 않습니다. 읽던 위치와 자료 선택만 이 브라우저에 저장됩니다.</p></details><details><summary>미래 자료가 잠겨 있는 이유는 무엇인가요?</summary><p>착수할 때 종료 결과를 먼저 보지 않도록 학습 순서를 나눴습니다. 공개 웹 교재의 자료 시점 선택은 학습 안내이며 접근 권한을 통제하는 기능은 아닙니다.</p></details></section>'''
    ...
    put('guide.html',shell('ERP 첫 사용 안내',markdown_html(manual)))
    ...
    for p in sorted((ROOT/'01_회사자료').glob('*.md')):
        ...
        put(name,shell(p.stem,markdown_html(p.read_text())).replace('href="index.html"','href="../index.html"').replace('href="learn.html','href="../learn.html').replace('href="erp.html"','href="../erp.html"').replace('href="guide.html"','href="../guide.html"').replace('href="resources.html"','href="../resources.html"'))
    body='<h1>학습 자료실</h1><p>현재 단계의 인쇄본과 빈 양식을 제공합니다. 문서 본문은 한 번 작성하고, 다음 단원에서 같은 문서의 버전을 이어 갑니다.</p><section class="card"><h2>현재 자료의 인쇄본</h2><p id="print-stage"></p><div id="print-links" class="actions"></div><p class="muted">미래 단계의 설명·예제는 해당 자료 시점의 인쇄본에서 열립니다. 시점은 교재 상단에서 바꿉니다.</p></section><h2>회사·용어 참고</h2><ul>'+company+'</ul><h2>편집할 문서 양식</h2><p>「양식 보기」에서 표를 읽고 복사하거나, Markdown 원본을 내려받아 사용하세요. 양식은 빈 문서이며 작성 예제는 해당 교재 단계에 있습니다.</p><div class="reading-table"><table><thead><tr><th>문서</th><th>브라우저로 보기</th><th>파일 보관</th></tr></thead><tbody>'+formrows+'</tbody></table></div>'
    ...
    for name in ['learn.html','erp.html']:
        p=out/name;s=p.read_text();s=s.replace('<header>', '<div style="padding:8px 22px;background:#e8f1e9"><a href="index.html">시작 안내</a> · <a href="resources.html">양식·인쇄본</a></div><header>',1);p.write_text(s)
